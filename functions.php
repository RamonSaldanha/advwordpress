...
function custom_card_shortcode($atts) {
	...
	<div class="col-12 mb-4">
			<div class="card text-dark bg-primary rounded border-0">
					<div class="card-body py-4">
							<div class="d-flex">
									...
									<div class="ms-4">
										<h4 editable="inline" class="fs-6 text-light m-0 p-0">
											<?php echo esc_html($atts['name']); ?>
										</h4>
										<div class="lc-block mt-2 text-muted">
											<div editable="rich">
												<p class="m-0 p-0 text-light opacity-75"><?php echo esc_html($atts['comment']); ?></p>
