...
<head>
  ...
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-YF76FDGBJ9"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
            ...
            <div class="col-lg-7 col-md-5 d-flex align-items-center">
              <ul class="nav redes-sociais">
                <li class="nav-item me-4 py-1">
                  <a href="https://wa.me/5584987329303" onclick="gtag_report_conversion()" target="_blank" class="text-muted">
                ...
                <li class="nav-item button">
                  <a href="<?php echo esc_url(home_url('agende-um-atendimento/')); ?>" onclick="gtag_report_conversion()" class=" btn btn-outline-secondary">
