...
<section class="text-light-emphasis header-background">
...
<div class="container d-flex justify-content-center align-items-center">
  <div class="row text-center pb-5 pt-3">
    <div class="col-md-8 mx-auto">
      <div class="lc-block"><span editable="inline" class="small mt-4 d-block text-uppercase">Equipe especializada</span>
    ...
    <div class="col-md-4 my-2">
      ...
      <div class="lc-block position-relative text-center mx-2 mt-n4 p-4 bg-light shadow" style="">
        ...
        <div class="">
          ...
          <p class="fw-bold">Contencioso em geral</p>
          <?php
            ...
            echo do_shortcode('[lc_block]Direito empresarial[/lc_block]');
            echo do_shortcode('[lc_block]Direito Imobiliário[/lc_block]');
        ?>
        <?php
