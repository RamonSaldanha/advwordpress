  ...
  <div class="row gx-md-5">
    ...
    <div class="col-md-4 py-4">
      ...
      <div class="d-grid gap-2 my-4">
        <a href="https://wa.me/5584987329303" on-click="gtag_report_conversion()" target="_blank" class="btn btn-lg text-uppercase fw-bold btn-outline-primary d-flex py-3" type="button">
        ...
        <a href="<?php echo esc_url(home_url('agende-um-atendimento/')); ?>" on-click="gtag_report_conversion()" class="btn btn-lg text-uppercase fw-bold btn-outline-primary d-flex py-3" type="button">
