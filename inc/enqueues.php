...
if (!function_exists('picostrap_get_css_optional_subfolder_name')) :
    function picostrap_get_css_optional_subfolder_name()
    {
        return "css-output/";
    }
endif;
...
if (!function_exists('picostrap_get_base_css_filename')) :
    function picostrap_get_base_css_filename()
    {
        return "bundle.css";
    }
endif;
...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script('bootstrap5', get_template_directory_uri() . "/js/bootstrap.bundle.min.js", array(), null, true);
}, 100);
...
function picostrap_get_headers()
{
    ...
    if (
        !get_theme_mod("disable_gutenberg") or
